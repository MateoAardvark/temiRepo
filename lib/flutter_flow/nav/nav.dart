...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'roomInquiry',
          path: '/roomInquiry',
          builder: (context, params) => const RoomInquiryWidget(),
        ),
        FFRoute(
          name: 'Qr_rest',
          path: '/qrRest',
          builder: (context, params) => const QrRestWidget(),
        ),
        FFRoute(
          name: 'Qr_other',
          path: '/qrOther',
          builder: (context, params) => const QrOtherWidget(),
        ),
        FFRoute(
          name: 'WebPage',
          path: '/webPage',
          builder: (context, params) => const WebPageWidget(),
        )
