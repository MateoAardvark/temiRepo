...
class PropertiesDataDuplicateTable
    extends SupabaseTable<PropertiesDataDuplicateRow> {
  @override
  String get tableName => 'propertiesData_duplicate';

  @override
  PropertiesDataDuplicateRow createRow(Map<String, dynamic> data) =>
      PropertiesDataDuplicateRow(data);
}

class PropertiesDataDuplicateRow extends SupabaseDataRow {
  PropertiesDataDuplicateRow(super.data);

  @override
  SupabaseTable get table => PropertiesDataDuplicateTable();
