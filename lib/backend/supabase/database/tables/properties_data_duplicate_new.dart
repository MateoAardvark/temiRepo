...
class PropertiesDataDuplicateNewTable
    extends SupabaseTable<PropertiesDataDuplicateNewRow> {
  @override
  String get tableName => 'propertiesData_duplicate_new';

  @override
  PropertiesDataDuplicateNewRow createRow(Map<String, dynamic> data) =>
      PropertiesDataDuplicateNewRow(data);
}

class PropertiesDataDuplicateNewRow extends SupabaseDataRow {
  PropertiesDataDuplicateNewRow(super.data);

  @override
  SupabaseTable get table => PropertiesDataDuplicateNewTable();
  ...
  String? get propertyDescription => getField<String>('propertyDescription');
  set propertyDescription(String? value) =>
      setField<String>('propertyDescription', value);
}
