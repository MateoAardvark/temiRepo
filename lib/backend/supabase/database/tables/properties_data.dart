...
class PropertiesDataTable extends SupabaseTable<PropertiesDataRow> {
  @override
  String get tableName => 'propertiesData';

  @override
  PropertiesDataRow createRow(Map<String, dynamic> data) =>
      PropertiesDataRow(data);
}

class PropertiesDataRow extends SupabaseDataRow {
  PropertiesDataRow(super.data);

  @override
  SupabaseTable get table => PropertiesDataTable();
