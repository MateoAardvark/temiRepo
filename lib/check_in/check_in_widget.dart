...
import '/components/successs_widget.dart';
...
class _CheckInWidgetState extends State<CheckInWidget> {
  ...
  void initState() {
    ...
    _model.bookingController ??= TextEditingController();
    _model.bookingFocusNode ??= FocusNode();
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(
                                  'Please fill out your booking details, and an assistant will respond to you shortly.',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          8.0, 0.0, 8.0, 0.0),
                                      child: TextFormField(
                                        controller: _model.bookingController,
                                        focusNode: _model.bookingFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText:
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options: ['US Number', 'Non-US Number']
                                          .toList(),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await PostZapierCall.call(
                                nombre: _model.nombreController.text,
                                bookingId: _model.bookingController.text,
                              ...
                              setState(() {
                                ...
                                _model.bookingController?.clear();
